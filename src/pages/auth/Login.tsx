        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-6">
              <div>
                <div>
                  <Button onClick={googleLogin} type="button" variant="outline" className="w-full cursor-pointer">
                ...
                <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t mt-5">
